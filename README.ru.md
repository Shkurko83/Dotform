...
См. [`LICENSE`](LICENSE): **All Rights Reserved**. Публичный доступ не даёт права копировать, изменять, форкать, коммерчески использовать код или применять метод DotForm Language без письменного разрешения.
